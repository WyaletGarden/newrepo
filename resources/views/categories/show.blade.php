                                ...
                                <div class="space-y-4">
                                        ...
                                        <div class="border rounded-lg p-4 hover:shadow-md transition duration-150 ease-in-out">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <p class="text-sm text-gray-500 font-semibold">{{ number_format($product->price) }} VNĐ</p>
                                    ...
                                    @if($category->products->count() > 5)
                                        <div class="text-center py-3">
                                            ...
                                            <a href="{{ route('products.index', ['category' => $category->id]) }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium mt-2 inline-block">
                                                Xem tất cả sản phẩm
                                            </a>
                                        </div>
                                    @endif
